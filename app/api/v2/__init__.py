...
from .views.parcel import Parcels, ParcelChangeDestination, AdminChangeStatus, AdminChangeLocation
...
api.add_resource(AdminChangeLocation, '/parcels/<parcelid>/presentLocation', strict_slashes=False)
